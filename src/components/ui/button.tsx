  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-surface text-fg shadow-[var(--shadow-border)] hover:bg-bg",
        outline:
          "border border-border bg-surface text-fg hover:bg-bg",
        ghost: "text-fg hover:bg-bg",
        work: "bg-work text-primary-foreground hover:bg-work/90",
        alt: "bg-alt text-primary-foreground hover:bg-alt/90",
      },
      size: {
        default: "h-11 px-4",
